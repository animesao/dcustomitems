<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-1.320.255-blue?style=for-the-badge" alt="Version">
...
cd ~/server/plugins
curl -L -o dcustomitems.jar https://github.com/animesao/dcustomitems/releases/download/v1.320.255/DC-CustomItems-1.320.255.jar
...
1. Download `DC-CustomItems-1.320.255.jar` from [Releases](https://github.com/animesao/dcustomitems/releases/tag/v1.320.255)
