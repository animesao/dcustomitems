...
| `/balance [игрок]` (алиасы `/bal`, `/money`) | `vault/` | Баланс свой или другого игрока |
| `/pay <игрок> <сумма>` | `vault/` | Перевод денег игроку |
| `/eco give\|take\|set\|reset <игрок> [сумма]` | `vault/` | Управление балансом (админ, право `dci.eco`) |
